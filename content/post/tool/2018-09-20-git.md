...
- 设置用户名：git config user.name hobocat
- 设置Email：git config user.email hobocat@126.com

系统用户级别设置

- 设置用户名：git config **--global** user.name hobocat
- 设置Email：git config **--global** user.email hobocat@126.com
